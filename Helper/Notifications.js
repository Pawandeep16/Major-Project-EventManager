...
const send_notification = (_n_data) => {
    console.log('PushDAta', _n_data)
    const message = JSON.parse(_n_data.data.data)
    PushNotification.createChannel(
        {
            channelId: "notify", // (required)
            channelName: "Notify_Notification", // (required)
            channelDescription: "Notify Notification", // (optional) default: undefined.
    ...
    PushNotification.localNotification(
        {
            ...
            channelId: "notify", // (required) channelId, if the channel doesn't exist, notification will not trigger.
